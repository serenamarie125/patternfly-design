...
## Vertical Bar Chart
![vertical-bar-chart-callout-1](img/vertical-bar-chart-callout-1.png)
  ...
  1. **Bar**
    ...
    - **Color:**
      -- For recommendations on fill colors, see the [Color Palette](../../styles/color-palette/).
    - **Height:**
...
![hoirzontal-bar-chart-callout-1](img/horizontal-bar-chart-callout-1.png)
